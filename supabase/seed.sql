...
-- Create dev users in auth.users (Supabase auth)
...
VALUES 
  -- Dev Driver 1 - Highway Heroes
  (
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
    '00000000-0000-0000-0000-000000000000',
    'dev.driver1@truckmate.app',
    ...
    '{"full_name": "Harpreet Singh", "role": "driver"}',
    false,
    '',
    '',
    '',
  ...
  -- Dev Driver 2 - Highway Heroes  
  (
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab',
    '00000000-0000-0000-0000-000000000000',
    'dev.driver2@truckmate.app',
    crypt('DevPassword123!', gen_salt('bf')),
    now(),
    '+15559876543',
    now(),
    ...
    'authenticated',
    '{"provider": "phone", "providers": ["phone"]}',
    '{"full_name": "Balwinder Singh", "role": "driver"}',
    false,
    '',
    '',
    '',
  ...
  -- Dev Admin - Highway Heroes
  (
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac',
    '00000000-0000-0000-0000-000000000000',
    'dev.admin@truckmate.app',
    crypt('DevPassword123!', gen_salt('bf')),
    now(),
    '+15550001111',
    now(),
...
VALUES
  ...
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac', '{"sub": "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac", "email": "dev.admin@truckmate.app"}', 'email', 'dev.admin@truckmate.app', now(), now(), now())
ON CONFLICT (id) DO NOTHING;

-- Create profiles linked to auth.users
INSERT INTO profiles (id, organization_id, full_name, phone_number, email_address, role)
VALUES 
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'Harpreet Singh', '+15551234567', 'dev.driver1@truckmate.app', 'driver'),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab', '11111111-1111-1111-1111-111111111111', 'Balwinder Singh', '+15559876543', 'dev.driver2@truckmate.app', 'driver'),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac', '11111111-1111-1111-1111-111111111111', 'Admin User', '+15550001111', 'dev.admin@truckmate.app', 'admin')
ON CONFLICT (id) DO NOTHING;
...
-- Insert sample trips with drivers
...
VALUES
  ('44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '33333333-3333-3333-3333-333333333335', '22222222-2222-2222-2222-222222222222', 'Los Angeles, CA', 'Phoenix, AZ', 124500, 124870, 'completed'),
  ('44444444-4444-4444-4444-444444444445', '11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '33333333-3333-3333-3333-333333333334', '22222222-2222-2222-2222-222222222223', 'Seattle, WA', 'Portland, OR', 187000, NULL, 'active'),
  ('44444444-4444-4444-4444-444444444446', '11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab', NULL, '22222222-2222-2222-2222-222222222224', 'Denver, CO', 'Salt Lake City, UT', 44500, NULL, 'deadhead')
ON CONFLICT (id) DO NOTHING;
...
BEGIN
  ...
  RAISE NOTICE 'Organization: Highway Heroes Trucking';
  RAISE NOTICE '========================';
END $$;
