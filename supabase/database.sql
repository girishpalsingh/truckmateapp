...
\restrict XewbTIz9R2mudl3cpgxmz1JNc8ovhtItz8lDo6gepFRyTId9ioDuXdiX3qnDwSk
...
--
-- Name: calculate_trip_profit(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.calculate_trip_profit(trip_uuid uuid) RETURNS TABLE(revenue numeric, expenses numeric, detention_revenue numeric, net_profit numeric, profit_margin numeric)
    LANGUAGE plpgsql
    AS $$
DECLARE
  load_rate NUMERIC;
...
--
-- Name: get_org_id_from_path(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_org_id_from_path(path text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: FUNCTION get_org_id_from_path(path text); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: log_document_event(uuid, uuid, text, text, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_document_event(p_document_id uuid, p_organization_id uuid, p_action text, p_storage_path text DEFAULT NULL::text, p_metadata jsonb DEFAULT '{}'::jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_audit_id uuid;
...
--
-- Name: FUNCTION log_document_event(p_document_id uuid, p_organization_id uuid, p_action text, p_storage_path text, p_metadata jsonb); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: search_documents(uuid, public.vector, double precision, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.search_documents(org_id uuid, query_embedding public.vector, match_threshold double precision DEFAULT 0.78, match_count integer DEFAULT 10) RETURNS TABLE(document_id uuid, content text, similarity double precision, metadata jsonb)
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: trigger_log_document_delete(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_log_document_delete() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: trigger_log_document_upload(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.trigger_log_document_upload() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  PERFORM log_document_event(
...
--
-- Name: ifta_reports; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: ifta_reports ifta_reports_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trucks trucks_organization_id_truck_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: document_embeddings_embedding_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_audit_log_doc_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_documents_ai_data; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_documents_trip; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_expenses_jurisdiction; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_expenses_trip; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ifta_org_quarter; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_loads_org; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trucks_org; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: documents document_delete_audit; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER document_delete_audit BEFORE DELETE ON public.documents FOR EACH ROW EXECUTE FUNCTION public.trigger_log_document_delete();


--
-- Name: documents document_upload_audit; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER document_upload_audit AFTER INSERT ON public.documents FOR EACH ROW EXECUTE FUNCTION public.trigger_log_document_upload();
...
--
-- Name: loads update_loads_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: document_audit_log document_audit_log_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: document_audit_log document_audit_log_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: documents documents_load_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: documents documents_trip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: organizations fk_admin; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ifta_reports ifta_reports_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ifta_reports ifta_reports_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: invoices invoices_load_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: invoices invoices_trip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: loads loads_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trips trips_load_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trucks trucks_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trips Drivers can manage own trips; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: loads Drivers can update load status; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles Managers can delete org profiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles Managers can insert profiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ifta_reports Managers can manage IFTA reports; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: loads Managers can manage loads; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: trucks Managers can manage trucks; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: organizations Org admins can update own organization; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: audit_log Service can insert audit logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: organizations System admins full access to organizations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles System admins full access to profiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ifta_reports Users can view org IFTA reports; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: audit_log Users can view org audit logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: document_embeddings Users can view org document embeddings; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: documents Users can view org documents; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: expenses Users can view org expenses; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: invoices Users can view org invoices; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: loads Users can view org loads; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles Users can view org profiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: trips Users can view org trips; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: trucks Users can view org trucks; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ifta_reports; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: document_audit_log org_audit_read_policy; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: document_audit_log server_audit_insert_policy; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: objects org_delete_policy; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY org_delete_policy ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'documents'::text) AND (public.get_org_id_from_path(name) = public.get_user_organization())));


--
-- Name: objects org_read_policy; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY org_read_policy ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'documents'::text) AND (public.get_org_id_from_path(name) = public.get_user_organization())));


--
-- Name: objects org_update_policy; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY org_update_policy ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'documents'::text) AND (public.get_org_id_from_path(name) = public.get_user_organization()))) WITH CHECK (((bucket_id = 'documents'::text) AND (public.get_org_id_from_path(name) = public.get_user_organization())));


--
-- Name: objects org_upload_policy; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY org_upload_policy ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'documents'::text) AND (public.get_org_id_from_path(name) = public.get_user_organization())));
...
\unrestrict XewbTIz9R2mudl3cpgxmz1JNc8ovhtItz8lDo6gepFRyTId9ioDuXdiX3qnDwSk
