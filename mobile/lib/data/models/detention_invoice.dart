...
class DetentionInvoice {
  ...
  DetentionInvoice copyWith({
    String? id,
    String? invoiceNumber,
    String? detentionRecordId,
    String? loadId,
    double? amount,
    double? totalDue,
    double? ratePerHour,
    ...
    String? detentionPhotoLink,
    DateTime? detentionPhotoTime,
    String? brokerEmail,
    DateTime? sentAt,
    DateTime? createdAt,
  }) {
    return DetentionInvoice(
      ...
      detentionRecordId: detentionRecordId ?? this.detentionRecordId,
      loadId: loadId ?? this.loadId,
      amount: amount ?? this.amount,
      totalDue: totalDue ?? this.totalDue,
      ratePerHour: ratePerHour ?? this.ratePerHour,
      totalHours: totalHours ?? this.totalHours,
      payableHours: payableHours ?? this.payableHours,
      currency: currency ?? this.currency,
      status: status ?? this.status,
      pdfUrl: pdfUrl ?? this.pdfUrl,
      poNumber: poNumber ?? this.poNumber,
      bolNumber: bolNumber ?? this.bolNumber,
      ...
      endLocationLng: endLocationLng ?? this.endLocationLng,
      detentionPhotoLink: detentionPhotoLink ?? this.detentionPhotoLink,
      detentionPhotoTime: detentionPhotoTime ?? this.detentionPhotoTime,
